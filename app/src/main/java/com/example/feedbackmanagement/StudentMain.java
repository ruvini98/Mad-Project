                                ...
                                dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.hasChildren()) {
                                            ...
                                            Toast.makeText(getApplicationContext(), "Cannot find Student 01", Toast.LENGTH_SHORT).show();
                                    }
                                    ...
                                    public void onCancelled(@NotNull DatabaseError databaseError) {
                                        ...
                                        butUpdate.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                dbRef.child("Student/01/id").setValue(txtID.getText().toString().trim());
                                                dbRef.child("Student").child("01").child("name").setValue(txtName.getText().toString().trim());
                                                dbRef.child("Student/01/email").setValue(txtEmail.getText().toString().trim());
                                                dbRef.child("Student/01/contactNo").setValue(txtContactNo.getText().toString().trim());
                                                dbRef.child("Student/01/subject").setValue(txtSubject.getText().toString().trim());
                                                dbRef.child("Student/01/feedback").setValue(txtFeedback.getText().toString().trim());

                                                Toast.makeText(getApplicationContext(), "Feedback Successfully Updated", Toast.LENGTH_SHORT).show();
                                                clearControls();
                                        ...
                                        private void clearControls() {
                                            ...
                                            butDelete.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View view) {
                                                    ...
                                                    //dbRef = removeValue();
                                                    Toast.makeText(getApplicationContext(), "Feedback Successfully Deleted", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                    }});}}
